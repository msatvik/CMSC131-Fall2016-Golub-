...
public class SuperSecretSpyApp extends javax.swing.JFrame {
	...
	private javax.swing.JRadioButton jRadioButtonRot31;
	...
	public SuperSecretSpyApp() {
		...
		buttonGroupSystem.add(jRadioButtonRot31);
	...
	private void buttonSpyItActionPerformed(java.awt.event.ActionEvent evt) {
		if (!jRadioButtonEncrypt.isSelected() 
		...
		else if (!jRadioButtonRot31.isSelected() 
			...
			if (jRadioButtonEncrypt.isSelected()) {
				jTextFieldCipher.setText(
						CryptoCode.rot31(jTextFieldPlain.getText()));
			}
			else {
				jTextFieldPlain.setText(
						CryptoCode.rot31(jTextFieldCipher.getText()));
			}
		}
	...
	private void jRadioButtonSystemStateChanged(javax.swing.event.ChangeEvent evt) {                                               
		if (jRadioButtonRot31.isSelected()) {
	...
	private void initComponents() {
		...
		jRadioButtonRot31 = new javax.swing.JRadioButton();
		...
		jRadioButtonRot31.setText("Rotate31");
		jRadioButtonRot31.addChangeListener(new javax.swing.event.ChangeListener() {
			public void stateChanged(javax.swing.event.ChangeEvent evt) {
																...
																.addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
																		...
																		.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
																				...
																				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
																						...
																						.addComponent(jRadioButtonRot31)
